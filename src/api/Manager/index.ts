import { type ITeamInfo, type IRange, type IManagerRole, type IResGetMember, type ITeamInfoLists, type IRole, type IResUploadExcel, type IEquipmentState, type IResDeviceExcel, type IDeviceEquipment, type IDeviceApply, type IGetSomeBodyReporters, type IGetUserTeamWork, type IGetusertimes, type IGetusertimeteamwork, type IUpdateInfo, type IResTeam, type IMemberExcelReturn, type UpdateUser, type IResMemberList, type ImemberList, type IResGetBackup } from "../../libs/model"
...
export const managerRegister = async (studentNo: string, password: string, role = 1) => {
  return await request({
    url: '/v1/user/account/registeradmin/',
    method: 'POST',
    data: {
      studentNo,
      password,
...
// 上传小组excel(步骤一)
export const exceladd = async (file: FormData) => {
  return await request<IUpdateInfo>({
    url: '/v1/team/management/exceladd/',
    method: 'POST',
    headers: { 'Content-Type': 'multipart/form-data' },
    data: file
  })
...
// 2. 根据excel导入小组（步骤二）
export const moreadd = async (teams: ITeamInfo[]) => {
  return await request({
    url: '/v1/team/management/moreadd/',
    method: 'post',
    data: teams
  })
}
...
export const getinfodetails = async () => {
  return await request<IResTeam[]>({
    url: '/v1/team/info/getinfodetails/',
    method: 'GET'
  })
}

// 单个创建小组
export const addOneTeamApi = async (
  no: string,
  teamName: string
) => {
  return await request({
    url: '/v1/team/management/teamadd/',
    method: 'POST',
    data: {
      no,
      teamName
...
// 批量上传成员第一步
export const excelregister = async (file: FormData) => {
  return await request<IMemberExcelReturn>({
    url: '/v1/user/account/excelregister/',
    method: 'POST',
    headers: { 'Content-Type': 'multipart/form-data' },
    data: file
...
// 批量上传第二步
export const registermore = async (correctUser: UpdateUser[]) => {
  return await request({
    url: '/v1/user/account/registermore/',
    method: 'POST',
    data: correctUser
...
// 单独导入成员信息
export const simpleMemberRegister = async (
  username: string,
  studentNo: string,
...
export const getlist = async (pageNum: number, pageSize: number) => {
  return await request<IResMemberList>({
    url: '/v1/user/account/getlist/',
    method: 'GET',
    params: {
      pageNum,
...
// 小组简单信息用于查询周报
export const getSelectMembers = async () => {
  return await request<ImemberList[]>({
    url: '/v1/team/info/getteaminfo/',
    method: 'GET'
  })
}

// 修改成员信息
export const editMembersInfos = async (
  id: string,
  username: string,
  studentNo: string,
  tel: string | null,
  ...
  return await request({
    url: '/v1/user/management/updateuserinfo/',
    method: 'POST',
    data: {
      id,
      username,
...
// 到处excel信息
export const infoExcel = async () => {
  return await request<IExcel>({
    url: '/v1/user/account/exportexcel/',
    method: 'GET',
    // responseType: 'blob',
    headers: {
...
// 获取备份版本内容
export const getbackups = async (pageNum: number, pageSize: number) => {
  return await request<IResGetBackup>({
    url: '/v1/backup/management/getbackups/',
    method: 'GET',
    params: {
      pageNum,
      pageSize
...
// 恢复指定版本sql数据
export const addrecover = async (version: string) => {
  return await request({
    url: '/v1/backup/management/addrecover/',
    method: 'POST',
    params: {
      version
    }
...
// 备份sql数据
export const addbackup = async (remark: string) => {
  return await request({
    url: '/v1/backup/management/addbackup/',
    method: 'POST',
    data: {
      remark
    }
