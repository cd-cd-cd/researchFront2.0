...
export const memberFunc: ITabBarCommon[] = [
  ...
  { label: '上传周报', value: 1, name: 'MemberWeekReport' },
  { label: '历史周报', value: 2, name: 'MemberHistoryReport' }
]
...
export const leaderFunc: ITabBarCommon[] = [
  ...
  { label: '上传周报', value: 2, name: 'LeaderWeekReport' },
  { label: '历史周报', value: 3, name: 'LeaderHistoryReport' },
  { label: '周报审核', value: 4, name: 'LSBReport' }
  // { label: '周报查询', value: 6, name: 'LAllReport' }
]

export const managerFunc: ITabBarCommon[] = [
  { label: '个人信息', value: 0, name: 'MInfo' },
  { label: '小组管理', value: 1, name: 'Team' },
  { label: '成员管理', value: 2, name: 'MNewMembers' },
  // { label: '成员管理', value: 1, name: 'TeamManage' },
  // { label: '设备管理', value: 3, name: 'MDevice' },
  { label: '设备管理', value: 3, name: 'NewMDevice' },
  { label: '周报审核', value: 4, name: 'MSBReport' },
  { label: '周报查询', value: 5, name: 'MAllReport' },
  { label: '数据备份', value: 6, name: 'DataBackup' }
]
        ...
        children: [
          {
            value: '1-1-1',
            title:
              '项目申请（申请材料撰写，答辩ppt制作等和项目申请相关的工作）',
            disabled: false
          },
          {
            value: '1-1-2',
      ...
      },
      {
        ...
        children: [
          ...
          },
          {
            ...
            disabled: false,
            title:
              '项目执行 （项目期间的数据采集，技术研发，项目出差，和甲方沟通等）'
          },
          {
            value: '1-2-3',
            disabled: false,
    ...
    children: [
      {
        ...
        disabled: false,
        title:
          '助教（协助完成课程管理，课程流程设计，组织考试，学生答疑，作业批改等课程日常工作）'
      },
      {
        value: '2-2',
        disabled: false,
        ...
        children: [
          {
            ...
            disabled: false,
            title:
              '招投标（采购调研，招投标，可行性分析等学校采购流程材料撰写，采购手续，合同签订等）'
          },
          {
            value: '3-1-2',
            disabled: false,
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        disabled: false,
        title:
          '涉密手续（跑学校的保密手续，涉密任务，涉密涉密材料撰写，团队的日常涉密任务等诸多涉密相关任务）'
      },
      {
        value: '4-3',
        disabled: false,
        title:
          '涉密项目（具体细则遵循项目服务，包括项目申请，项目中期，项目结题等）'
      }
    ]
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        disabled: false,
        title:
          '团队宣传与招生（夏令营宣讲，代表团队进行学术报告，宣传新闻稿撰写，宣传海报制作，宣传视频设计，招生面试等）'
      },
      {
        value: '5-4',
        disabled: false,
      ...
      },
      {
        ...
        disabled: false,
        title:
          '其他（其他财务流程，独立于上述各点的材料书写，方案设计，科研小组组长）'
      }
    ]
  },
  {
    ...
    disabled: false,
    title:
      '其他此项包括任何独立于上述选项的额外的因团队占用大块时间的部分（比如所庆，承办大型会议，接待外校老师等）'
  }
]
