...
export default function LSBReport() {
  ...
  return (
    <div className={style.back}>
      ...
      </div>
      {
        searchType === 0 || searchType === 1
          ...
          >
            ...
            <Column title='周报状态(组长)' dataIndex="leaderStatus" key="leaderStatus" render={(value: 0 | 1 | 2) => renderastatus(value)}></Column>
      ...
      {
        detail ? <Detail getUserList={getUserList} getSource={() => getSource(false)} reportSearch={() => reportSearch(false)} searchType={searchType} detail={detail} detailReturn={() => setDetail(undefined)}></Detail> : null
      }
      {
        <Modal
