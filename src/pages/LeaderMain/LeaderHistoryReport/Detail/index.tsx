...
import { type IGetreportcomment, getreportcomment, delreportcomment } from '../../../../api/Manager'
import { type IDomEditor, type IToolbarConfig, type IEditorConfig } from '@wangeditor/editor'
      ...
      <div className={style.main} id='report'>
        ...
        <div className={style.commentDiv}>
          <div className={style.btn_box}>
            <Button type={commentType === 0 ? 'primary' : 'default'} onClick={() => setCommentType(0)}>管理员-组长</Button>
          </div>
        ...
        <div className={style.editorMain}>
          ...
          <Button className={style.sendMessage} onClick={() => returnComments()}>回复</Button>
        </div>
      </div>
    </div>
  )
