    ...
    <div className={style.back}>
            ...
            <div className={style.info}>
              ...
              <div className={style.changeInfo}>
                {info?.phone ? (
                  ...
                  <div className={style.nullText}>还未设置手机号</div>
                )}
                {/* {item?.label !== 'phoneNumber' ? (
                  ...
                  <div>
                    <Input
                      ...
                      value={item?.value}
                      onChange={(e) => {
                        setItem({ label: 'phoneNumber', value: e.target.value })
                      }}
                    ></Input>
              ...
              <div className={style.changeInfo}>
                {info?.email ? (
                  ...
                  <div className={style.nullText}>还未设置邮箱</div>
                )}
                {/* {item?.label !== 'email' ? (
                  info?.email ? (
                    info.email
                  ...
                  <div>
                    <Input
                      ...
                      value={item?.value}
                      onChange={(e) => {
                        setItem({ label: 'email', value: e.target.value })
                      }}
                    ></Input>
                    <div className={style.warn}>{warn}</div>
                  </div>
                ...
                {item?.label === 'email' ? (
                  ...
                  <a
                    className={style.modify}
                    onClick={() => {
                      setItem({ label: 'email', value: info?.email as string })
                    }}
                  >
                    修改
                  </a>
              ...
              <div className={style.changeInfo}>
                {info?.cardno ? (
                  ...
                  <div className={style.nullText}>暂无身份证信息</div>
                )}
              </div>
            </div>
          </div>
      ...
      <div className={style.password_box}>
        ...
        <div className={style.secure_box}>
          <span>修改密码</span>
          <a className={style.modify} onClick={showModal}>
            修改
          </a>
        </div>
      </div>
      <Modal
        ...
        footer={null}
      >
        <Form {...layout} form={form} name="passwordChange" onFinish={onFinish}>
          <Form.Item
            label="原密码"
            name="oldPassword"
            rules={[
